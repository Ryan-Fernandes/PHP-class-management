<?php
    if(isset($_POST['add_enquiry_details'])){
        ...
        $enquiry = new Enquiry();
        $enquiry_id = $enquiry->insertEnquiry($student_first_name,$student_last_name,$student_email,$student_number,$student_branch,$student_sem,$stream_id,$reference,$student_college,$comments);
        
        Functions::redirect("enquiry.php?q=view&op=add&p=success&page=enquiry");
    }
?>
<!-- ============================================================== -->
						...
						<div class="card-box">
							...
							<form class="" name="add-enquiry" id="add-enquiry" action="#" method="post">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" name="student_sem" id="student_sem" required placeholder="Enter Semester" />
								</div>   
                                <!--END OF Sem-->                                                               
                                <!--COLLEGE-->
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" name="reference" id="reference" required placeholder="Enter Reference" />
								</div> 
                                <div class="form-group">
									<label for="comments">Comments</label>
									<input type="text" class="form-control" name="comments" id="comments" required placeholder="Enter Comments" />
								</div>   
                                <!--END OF Stream ID-->
